...
def main():
  source_file_list = "C:/Server/train.txt"  # CHANGE PATH TO YOUR FILE - LIST of jpg files with xml file next to them in the same directory
  dest_csv_file = 'C:/Server/train.csv'  # CHANGE PATH TO YOUR FILE
  ...
  print('[', time.ctime(), ']' , 'Successfully Convert Train Annotation Files to CSV!')
