...
def main():
  source_file_list = "C:/Server/test.txt"  # CHANGE PATH TO YOUR FILE - LIST of jpg files with xml file next to them in the same directory
  dest_csv_file = 'C:/Server/test.csv'  # CHANGE PATH TO YOUR FILE
  ...
  print('[', time.ctime(), ']' , 'Successfully Convert Test Annotation Files to CSV!')
